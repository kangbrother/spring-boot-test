...
public class HttpRequestUtil {
    ...
    public static String sendPost(String url, String param,boolean isproxy) {
        ...
        try {
            ...
            rest.put("errCode", 500);
            rest.put("errDesc", e.getMessage());
...
//            System.out.println(line);  
    ...
    public static void main(String[] args) {
        ...
        try {
        	String url="http://newhouse.sh.fang.com/house/ajaxrequest/search_keyword_submit.php?t=0.582803015364334&city=上海&keyword=天安花园";
            String str=sendPost1(url);
